...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="tableCss4">
  ...
  <tr>
   ...
   <tr>
     ...
     <td class="tdBorder1">
     <select name="status">
     <option value="0" <?=selected($data['status'],0)?>>无效</option>
     <option value="1" <?=selected($data['status'],1)?>>未受理</option>
     <option value="2" <?=selected($data['status'],2)?>>受理中</option>     
     <option value="3" <?=selected($data['status'],3)?>>已发货</option>
     <option value="4" <?=selected($data['status'],4)?>>已结束</option>
     </select></td>
   </tr>
   <tr>
