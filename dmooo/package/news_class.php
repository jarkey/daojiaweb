...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="tableCss4">
  <tr>
    <td colspan="3" class="tdBorder1 titleBg1">套餐类别</td>
    </tr>
  <?php
...
<tr valign="middle">
	  <td class="tdBorder1">
	 <a href="news_class2.php?fid=<?=$id?>&keepThis=true&TB_iframe=true&height=400&width=700" title="<?=$name1?> / 二级频道管理" class="thickbox"><?=$name?></a></td>
