...
<form action="news_class1.php?update=<?=$id?>&fid=<?=$pid?>" method="POST">
 ...
 <td align="center" class="tdBorder1"><a href="news_class1.php?del=<?=$id?>&fid=<?=$pid?>" onClick="return window.confirm('删除将会删除该栏目下的所有记录，确定删除吗?')"><img src="../images/del.gif" alt="删除" border="0" /></a></td>
</tr>
<?php
}
?>
