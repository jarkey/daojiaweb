 ...
 if ($_POST['ifMail']==1)
  {
	  ...
	  $status_str=serviceStatus($_POST['processStatus']);	    //投诉处理状态
	  $mail_num=8;
...
/********************/  
	...
	echo '<script>alert("修改投诉成功");top.mainFrame.rightFrame.location.reload(true);window.close();</script>';	
}else{
	echo '<script>alert("修改投诉失败");top.mainFrame.rightFrame.location.reload(true);window.close();</script>';		
	}
}	
?>
<html><head>
...
$i=serviceStatus($status);  //判断投诉处理状态
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="tableCss4">
   ...
   <tr>
     <td width="100" class="tdBorder1">投诉内容：</td>
