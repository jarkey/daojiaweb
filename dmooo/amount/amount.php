...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" align="right"><a href="add_amount.php?userId=<?=$_GET['userId']?>&userName=<?=$_GET['userName']?>&email=<?=$_GET['email']?>" class="red1Href" style=" font-weight:bold; font-size:14px;">+管理帐户</a></td>
  </tr>
</table>
<?php 
}
...
if ($userIdIf==1) $sql=$sql." where logIndex=2 and userid=".$_GET['userId'];
