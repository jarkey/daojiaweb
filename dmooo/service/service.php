...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" align="right"><a href="add_service.php?userId=<?=$_GET['userId']?>" class="red1Href" style=" font-weight:bold; font-size:14px;">+添加服务</a></td>
  </tr>
</table>
<?php 
}
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="tableCss4">
  <tr>
    <td colspan="7" class="tdBorder1 titleBg1">售后服务</td>
    </tr>
  <tr align="center">
<td class="tdBorder1 tdBg1">服务编号</td>
<td class="tdBorder1 tdBg1">提交时间</td>
<td class="tdBorder1 tdBg1">处理时间</td>
<td class="tdBorder1 tdBg1">服务主题</td>
<td class="tdBorder1 tdBg1">服务专员</td>
<td class="tdBorder1 tdBg1">服务状态</td>
...
$num=12;
$sql="select serviceId from gplat_service where serviceIndex=1";
...
$sql="select * from gplat_service where serviceIndex=1";
if ($userIdIf==1) $sql=$sql." and userid=".$_GET['userId'];
