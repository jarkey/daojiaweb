...
function GetProvinceText(QId,SId){
	...
	xmlhttp.onreadystatechange= function(){
		if(xmlhttp.readyState==4){
			CountyText.innerHTML="&nbsp;<select name='County' style='width:90px;height:19px'><option value='' selected>县级市、县</option></select>";
			CityText.innerHTML="&nbsp;<select name='City' style='width:90px;height:19px'><option value='' selected>地级市</option></select></select>";
