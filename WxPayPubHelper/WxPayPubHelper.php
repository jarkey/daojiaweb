 ...
 * 		订单查询接口--OrderQuery
 * 		退款申请接口--Refund
 * 		退款查询接口--RefundQueryNativeLink_pub
 * 		对账单接口--DownloadBill
 * 		短链接转换接口--ShortUrl
 * 【响应型接口】--Wxpay_server_
 * 		通用通知接口--Notify
 ...
 * 		createNoncestr()，产生随机字符串，不长于32位createOauthUrlForCode
 * 		getSign(),生成签名
...
class Common_util_pub
{
	...
	function do_post_request($data, $url, $optional_headers = null)
  {
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function postXml()
	{
		...
		//$this->response = $this->do_post_request($xml,$this->url);
